...
//Para versões posteriores: deixar mais estético (""animações"" com os leds indicando derrota ou vitória, inclusive o aguardo do jgoador) e criar uma função para detectar quando o jogador deseja continuar ou parar o jogo.
